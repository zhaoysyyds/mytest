    ...
    <div class="top">
        ...
        <div class="top-return">
            <button class="b-button" type="button">
                <a class="return" href="${pageContext.request.contextPath}/view/native/class_information.jsp">返回</a>
            </button>
        </div>
    ...
    <div class="bottom" style="margin-left: 25px;">
        ...
        <div class="top-3">
            <form style="font-size: 17px;">
                用户名称：<input style="width: 100px;height: 25px;font-size: 16px;" id="name" type="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="width: 20px;height:20px;">&nbsp;&nbsp;&nbsp;&nbsp;</span>
                站内信息：<input style="width: 200px;height: 25px;font-size: 16px;" id="message" type="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="width: 20px;height:20px;">&nbsp;&nbsp;&nbsp;&nbsp;</span>
                起始日期：<input style="width: 150px;height: 25px;font-size: 16px;" id="date" type="date">&nbsp;&nbsp<span style="width: 20px;height:20px;">&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<script type="text/javascript">
    ...
    condition=function () {
        ...
        $.ajax({
            ...
            success:function () {
                //刷新显示数据的容器
                $("#check").load("${pageContext.request.contextPath}/view/native/communication.jsp #check");
            }
        });
    }
